...
# flat. Used by tts.sh's speak_inworld path (talk skill + hermes voice notes).
#
# Usage:
...
# across sentences. The prompt therefore tags every sentence. See
# docs/providers.md for the full rationale.
#
# Config (env):
